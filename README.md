...
**1.Unit Testing** : Unit tseting is one of the key aspects in development, I will improve the quality of unittesting in our team by more stringent testing.
**2.Modularity** : Modularity is one of the key takeaway for me and using this in our development will help dividing functionality which will improve the redability and testability of the code.
**3.Test specifications** : The importance of Test spec is realized to me and I will try to write all possible scenarios for testing in my project.
